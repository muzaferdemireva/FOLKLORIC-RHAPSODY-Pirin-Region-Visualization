...
function preload() {
  video = createVideo("pirinska.mp4", () => { video.hide(); videoLoaded = true; });
  img = loadImage("pirinska-colours.png", () => imgLoaded = true);
  icon = loadImage("pirinska-icon.png", () => iconLoaded = true);
...
function setup() {
  ...
  document.title = "Pirin Region | Folkloric Rhapsody"; 
